...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert wildlife biologist and outdoor safety advisor. Given an image of an animal, identify it and provide a safety assessment.
...
If the image does not contain an identifiable animal, still use the tool but set the name to "Unknown" with low confidence and provide general wildlife safety tips.`;
          ...
          messages: [
            { role: "system", content: systemPrompt },
            {
              ...
              content: [
                ...
                {
                  type: "text",
                  text: "Identify this animal and assess the threat level for a hiker encountering it.",
                },
              ],
            },
          ],
          tools: [
            {
              ...
              function: {
                ...
                description:
                  "Return structured data about the identified animal",
                parameters: {
                  type: "object",
                  properties: {
                    name: {
                    ...
                    profile: {
                      type: "string",
                      description:
                        "Brief 2-3 sentence profile of the animal",
                    },
                    conservationStatus: {
                      type: "string",
                      description:
